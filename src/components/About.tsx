          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-2xl p-4 sm:p-6 text-white text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-3">
                <button
                  onClick={() => handlePDFDownload('/Aurimas_Resume_16042026_AI_Product_Manager.pdf', 'Aurimas_Nausedas_CV_English.pdf')}
                ...
                <button
                  onClick={() => handlePDFDownload('/Aurimas_Resume_16042026_AI_Product_Manager_LT.pdf', 'Aurimas_Nausedas_CV_Lithuanian.pdf')}
                  className="bg-white px-3 sm:px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2 text-xs sm:text-sm text-gray-800"
                >
                  <Download className="w-4 h-4" />
                ...
                <button
                  onClick={() => handlePDFDownload('/Aurimas_Resume_16042026_AI_Product_Manager_FR.pdf', 'Aurimas_Nausedas_CV_French.pdf')}
                  className="bg-white px-3 sm:px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2 text-xs sm:text-sm text-gray-800"
                >
                  <Download className="w-4 h-4" />
