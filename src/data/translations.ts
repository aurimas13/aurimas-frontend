export const translations = {
  en: {
    ...
    support: {
      ...
      cardTitle: "Support by Card",
      cardDescription: "Secure card payment via Stripe — choose a one-time gift or a monthly contribution.",
      oneTimeLabel: "One-time",
      monthlyLabel: "Monthly",
      payByCard: "Continue to secure checkout",
      processing: "Redirecting to secure checkout…",
      optionalEmail: "Email (optional, for your receipt)",
      cardSecurePromise: "You'll be redirected to Stripe's secure checkout. Card details never touch this site.",
      checkoutError: "We couldn't start the checkout. Please try again or use PayPal below.",
  ...
  lt: {
    ...
    support: {
      ...
      cardTitle: "Paremti kortele",
      cardDescription: "Saugus mokėjimas kortele per Stripe — pasirinkite vienkartinę dovaną arba mėnesinį įnašą.",
      oneTimeLabel: "Vienkartinis",
      monthlyLabel: "Kas mėnesį",
      payByCard: "Tęsti į saugų apmokėjimą",
      processing: "Nukreipiama į saugų apmokėjimą…",
      optionalEmail: "El. paštas (nebūtina, kvitui)",
      cardSecurePromise: "Būsite nukreipti į saugų Stripe apmokėjimą. Kortelės duomenys niekada nepatenka į šią svetainę.",
      checkoutError: "Nepavyko pradėti apmokėjimo. Bandykite dar kartą arba naudokite PayPal žemiau.",
  ...
  fr: {
    ...
    support: {
      ...
      cardTitle: "Soutenir par carte",
      cardDescription: "Paiement par carte sécurisé via Stripe — choisissez un don unique ou une contribution mensuelle.",
      oneTimeLabel: "Ponctuel",
      monthlyLabel: "Mensuel",
      payByCard: "Continuer vers le paiement sécurisé",
      processing: "Redirection vers le paiement sécurisé…",
      optionalEmail: "E-mail (facultatif, pour votre reçu)",
      cardSecurePromise: "Vous serez redirigé vers le paiement sécurisé de Stripe. Les données de carte ne transitent jamais par ce site.",
      checkoutError: "Impossible de démarrer le paiement. Réessayez ou utilisez PayPal ci-dessous.",
