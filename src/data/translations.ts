export const translations = {
  ...
  fr: {
    ...
    blogs: {
      ...
      joinWaitlist: "Rejoignez la prochaine newsletter en dehors de la plateforme Substack, où elle se trouve actuellement, comme indiqué ci-dessous, pour être informé de sa sortie et des nouveaux articles",
